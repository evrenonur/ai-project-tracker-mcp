...
export type StepType = 'analysis' | 'file_read' | 'file_write' | 'code_generation' | 'dependency_install' | 'command_execution' | 'testing' | 'debugging' | 'optimization' | 'deployment' | 'documentation' | 'research' | 'planning' | 'review' | 'custom';
